...
void frame0() {
    ...
    drawBitmapText("Namratha J", fonts[3], -50, 100);
    drawBitmapText("Mahima N Shah", fonts[3], -50, 10);

    glColor3f(0.545098039, 0.270588255, 0.0);
    drawBitmapText("1RN19CS084", fonts[0], 120, 100);
    drawBitmapText("1RN19CS072", fonts[0], 120, 10);
